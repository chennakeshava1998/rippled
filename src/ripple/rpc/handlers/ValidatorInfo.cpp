...
doValidatorInfo(RPC::JsonContext& context)
{
    ...
    ret[jss::master_key.c_str()] = toBase58(TokenType::NodePublic, mk);
    ...
    ret[jss::ephemeral_key.c_str()] = toBase58(TokenType::NodePublic, ek);
