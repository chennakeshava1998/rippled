...
public:
     ...
     */
    void
    newValidators(LedgerIndex seq, hash_set<PublicKey> const& nowTrusted);

private:
    PublicKey const myValPubKey_;
    beast::Journal j_;
    mutable std::mutex mutex_;
    hash_map<PublicKey, LedgerIndex> newValidators_;
     ...
     */
    PublicKey
    choose(uint256 const& randomPadData, std::vector<PublicKey> const& candidates);
